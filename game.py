...
class Hangman:
  ...
  # Método para checar o status de game e imprimir o board na tela
...
def rand_palavra():
  ...
  palavras = ['banana', 'abacate', 'uva', 'morango', 'laranja', 'tangerina', 'maracuja']
...
def main():
  ...
  # Enquanto o jogo não tiver terminado, print do status, solicita uma letra e faz a leitura do carater
